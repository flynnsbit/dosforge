...
from .dependencies import assert_dependencies, find_missing
...
class DiskManager:
    ...
    def _validate_create_request(self, request: CreateRequest) -> None:
        ...
        if request.boot_mode is BootMode.MSDOS71 and request.disk_format is not DiskFormat.FAT32:
            raise ValidationError("MS-DOS 7.1 boot mode is only supported for FAT32.")
        if (
