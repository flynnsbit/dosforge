...
class VhdMakerApp(App[None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(id="layout"):
            ...
            with Vertical(id="right-pane"):
                ...
                yield Select(
                    options=[
                        ("MS-DOS 7.1 minimal install", MSDOSInstallProfile.MINIMAL.value),
                        ("MS-DOS 7.1 full C:\\DOS install", MSDOSInstallProfile.FULL.value),
                    ],
    ...
    def _request_from_form(self) -> CreateRequest:
        ...
        return CreateRequest(
            ...
            msdos_install_profile=MSDOSInstallProfile(msdos_profile_value),
        )
