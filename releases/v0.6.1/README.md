# dosforge 0.6.1 — release bundle

This folder is a self-contained, **source-free** installable bundle of
`dosforge` version **0.6.1**. It contains everything you need to
...
| File / dir                                  | Purpose                                                                 |
|---------------------------------------------|-------------------------------------------------------------------------|
| `dosforge-0.6.1-py3-none-any.whl`     | Pure-Python wheel (preferred install artifact)                          |
| `dosforge-0.6.1.tar.gz`               | Source distribution (for building from source)                          |
...
```bash
pipx install ./dosforge-0.6.1-py3-none-any.whl
# or
python3 -m pip install --user ./dosforge-0.6.1-py3-none-any.whl
```
