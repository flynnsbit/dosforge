# dosforge 0.6.2 — release bundle

This folder is a self-contained, **source-free** installable bundle of
`dosforge` version **0.6.2**. It contains everything you need to
...
| `dosforge-0.6.2.tar.gz`               | Source distribution (for building from source)                          |
...
```bash
pipx install ./dosforge-0.6.2-py3-none-any.whl
# or
python3 -m pip install --user ./dosforge-0.6.2-py3-none-any.whl
```
