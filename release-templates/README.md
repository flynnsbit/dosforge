# dosforge @@VERSION@@ — release bundle

This folder is a self-contained, **source-free** installable bundle of
`dosforge` version **@@VERSION@@**. It contains everything you need to
...
```bash
pipx install ./dosforge-@@VERSION@@-py3-none-any.whl
# or
python3 -m pip install --user ./dosforge-@@VERSION@@-py3-none-any.whl
```
